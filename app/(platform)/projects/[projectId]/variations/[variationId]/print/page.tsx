  ...
  return (
    <main className="min-h-screen bg-neutral-100 px-6 py-10 text-neutral-900 print:bg-white print:px-0 print:py-0">
      ...
      <div className="page mx-auto max-w-4xl rounded-2xl border border-neutral-200 bg-white p-10 shadow-sm print:max-w-none print:rounded-none print:border-0 print:p-8 print:shadow-none">
        ...
        <section className="mt-10 grid gap-4 rounded-xl border border-neutral-200 p-4 text-sm sm:grid-cols-2">
          <div>
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-neutral-500">Requested By</p>
            <p className="mt-2 text-neutral-900">{vo.requestedBy ?? "-"}</p>
          </div>
          <div className="sm:text-right">
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-neutral-500">Time Impact</p>
            <p className="mt-2 text-neutral-900">{vo.timeImpactDays ?? 0} days</p>
          </div>
        </section>
