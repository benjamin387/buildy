...
export function PurchaseOrderLinesEditor(props: {
  name: string;
  initialLines?: Line[];
  gstRate: number;
                ...
                <tr key={index} className="border-t border-neutral-200 bg-white">
                  ...
                  <td className="px-3 py-3 align-top">
                    <input
                      ...
                      className="h-10 w-[30rem] max-w-[78vw] rounded-lg border border-neutral-300 bg-white px-2 outline-none ring-neutral-400 focus:ring-2"
